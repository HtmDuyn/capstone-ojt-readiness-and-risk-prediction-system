...
const LoginPage: React.FC = () => {
  ...
  const performMockLogin = (role: Role) => {
    const mockUser = {
      id: mockStudentProfile.studentCode,
      name: mockStudentProfile.fullName,
      email: mockStudentProfile.email,
      role: role === "student" ? ("student" as const) : (role as any),
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 relative bg-slate-950 overflow-y-auto">
      {/* Fixed Fullscreen Wallpaper Background (100% viewport coverage without seam lines) */}
