...
const INITIAL_PROPOSALS: ClassProposal[] = [
...

  {
    ...
    recommendation:
      "Đề xuất xem xét mở lớp hỗ trợ PRN231.",
  ...
  if (selectedProposal) {
    ...
    return (
      <div className="space-y-6">
        ...
        <PageBanner
          title="Chi tiết Đề xuất Mở lớp"
          description="Xem lý do AI đề xuất và nhóm sinh viên đang có nhu cầu hỗ trợ."
          badge="AI đề xuất"
        />
            ...
            <div className="flex gap-4">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  >
                    Ưu tiên {proposal.priority.toLowerCase()}
                  </span>
                ...
                <p className="mt-2 flex items-center gap-1.5 text-xs text-slate-400">
                  <Clock3 size={14} />
                  AI ghi nhận: {proposal.detectedAt}
                </p>
              </div>
            </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Nhóm sinh viên được AI sử dụng để hình thành đề xuất này.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="divide-y divide-slate-100">
            {proposal.affectedStudents.map((student) => (
              <div
                key={student.id}
          ...
          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                AI chỉ đưa ra đề xuất. Phòng Đào tạo quyết định có sử dụng
                đề xuất này để chuẩn bị lớp hỗ trợ hay không.
              </p>
            </div>

            {proposal.status === "Chờ xem xét" ? (
            ...
            <div className="mt-5 rounded-xl border border-blue-100 bg-blue-50 p-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm leading-6 text-blue-700">
                  Đề xuất đã được chấp nhận và có thể được sử dụng ở bước
                  <strong> Tạo lớp học hỗ trợ</strong>. Việc chấp nhận đề
                  xuất chưa đồng nghĩa lớp đã được tạo.
                </p>
              </div>
            </div>
          )}
  ...
  return (
    <div className="space-y-6">
      <PageBanner
        ...
        description="Xem các đề xuất lớp hỗ trợ được hình thành từ dữ liệu học tập và Risk của sinh viên."
        ...
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                AI phát hiện các nhóm sinh viên có nhu cầu học tập tương
                tự và đề xuất PĐT cân nhắc mở lớp hỗ trợ.
              </p>
            </div>
          </div>
      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            AI chỉ đề xuất; quyết định mở lớp thuộc Phòng Đào tạo.
          </p>
        </div>
      ...
      {acceptedProposals.length > 0 && (
        <section className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Các đề xuất PĐT đã đồng ý xem xét để tạo lớp hỗ trợ.
            </p>
          </div>
      ...
      <section className="rounded-2xl border border-blue-100 bg-blue-50 p-4">
        <div className="flex gap-3">
          ...
          <p className="text-sm leading-6 text-blue-700">
            ...
            backend, hệ thống sẽ nhận đề xuất dựa trên dữ liệu học tập và
            kết quả Risk. PĐT vẫn là bên quyết định có tạo lớp hỗ trợ hay
            không.
          </p>
        </div>
      </section>
