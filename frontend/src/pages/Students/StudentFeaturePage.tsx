...
import { getMenuItemByPath } from '../../config/studentMenuConfig';
import {
  BotSparkleIcon,
...
export const StudentFeaturePage: React.FC = () => {
  ...
  const currentMenu = getMenuItemByPath(location.pathname);

  return (
    <StudentLayout>
      <div className="space-y-6">
        {/* Reusable Welcome Banner matching this route automatically */}
        <WelcomeBanner
