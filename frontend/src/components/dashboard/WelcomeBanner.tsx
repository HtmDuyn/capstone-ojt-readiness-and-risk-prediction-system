...
import { getMenuItemById, getMenuItemByPath } from '../../config/studentMenuConfig';
...
export interface WelcomeBannerProps {
  /** Student profile for personalized greeting and data */
  student?: StudentProfile;
  /** Explicit menu key corresponding to sidebar item (e.g., 'academic-profile', 'risk-prediction') */
  menuId?: string;
  ...
  /** Extra slot (e.g. semester dropdown, filter pills, quick metric) placed on the right */
  ...
  // Backward compatibility props for existing dashboard usage
  onRegisterOjt?: () => void;
  onViewRoadmap?: () => void;
}
...
export const WelcomeBanner: React.FC<WelcomeBannerProps> = ({
  ...
  const preset = menuId
    ...
    : getMenuItemByPath(location.pathname) || getMenuItemById('dashboard');
