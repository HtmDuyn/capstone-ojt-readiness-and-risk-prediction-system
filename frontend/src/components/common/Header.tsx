...
export const Header: React.FC<HeaderProps> = ({
  ...
  const currentUser: HeaderUserSummary = user || (student ? {
    fullName: student.fullName,
    code: student.studentCode,
    subtitle: `${student.studentCode} - ${student.semester}`,
    email: student.email,
    ...
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 px-4 sm:px-8 py-3.5 bg-white/70 backdrop-blur-xl border-b border-white/60 shadow-xs text-slate-800">
      ...
      <div className="flex items-center gap-3 flex-1 max-w-xl">
        <button
          ...
          className="p-2 rounded-xl text-slate-600 hover:bg-orange-50 lg:hidden focus:outline-none cursor-pointer"
        ...
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            placeholder="Tìm kiếm thông tin, lộ trình, OJT..."
          ...
          >
            <div className="hidden md:block text-right">
              ...
              <div className="text-[11px] text-slate-500 font-medium">
                {currentUser.subtitle || currentUser.code || currentUser.email}
              </div>
            </div>
                ...
                <div className="px-2 py-1 border-b border-slate-100">
                  <div className="px-3 py-2 text-xs text-slate-600">
                    <div className="flex justify-between py-0.5">
                      <span className="text-slate-400">Mã số:</span>
